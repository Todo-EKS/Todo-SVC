...
function setupDb() {
  ...
  console.log('process.env.RDS_POSTGRES_DB_USERNAME ', process.env.RDS_POSTGRES_DB_USERNAME)
  console.log('process.env.RDS_POSTGRES_DB_PASSWORD ', process.env.RDS_POSTGRES_DB_PASSWORD)
